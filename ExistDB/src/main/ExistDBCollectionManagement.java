...
public class ExistDBCollectionManagement {
    ...
    public static void main(String[] args) {
        try {
            ...
            String[] collectionsToCreate = {"/instituto/biblioteca/novelas"};
            ...
            col = DatabaseManager.getCollection(URI + rootCollectionPath + "/instituto/biblioteca/novelas", USER, PASSWORD);
            if (col == null) {
